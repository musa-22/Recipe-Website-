	...
	<div class="container">
		...
		// / activating search button
			...
			elseif (isset($_GET["page"])) {
			    ...
			    $xxx = "meat";
			    $aa = "Meat";
			    $sql = "SELECT * FROM  recipesmarco WHERE meat = '$xxx' OR meat = '$aa' ORDER BY id desc LIMIT  $DifferentPostSho,3";
			    ...
			    $xxx = "meat";
			    $aa = "Meat";
			    $sql = "SELECT * FROM  recipesmarco WHERE meat = '$xxx' OR meat = '$aa'  ORDER BY id desc LIMIT 0,3";
			...
			?>
					...
					<nav style="padding: 25px;">
						...
						<li class="page-item" > <a href="FrontMea.php?page=<?php echo $Page-1;?>" class="page-link">&laquo;</a></li>
						...
						$sql = "SELECT COUNT(*) FROM recipesmarco WHERE meat = '$xxx' OR meat = '$aa' ";
						...
						<li class="page-item" > <a href="FrontMea.php?page=<?php echo $i;?>" class="page-link"><?php echo $i;?></a></li>
						<?php }?>
						...
						<li class="page-item" > <a href="FrontMea.php?page=<?php echo $Page+1;?>" class="page-link">&raquo;</a></li>
