...
<html>
	...
	<body>
		...
		elseif (isset($_GET["page"])) 
		{
		    ...
		    $xxx = "Vegetarian";
		    $aa = "vegetarian";
		    $sql = "SELECT * FROM  recipesmarco WHERE vegetarian = '$xxx' OR vegetarian = '$aa' ORDER BY id desc LIMIT  $DifferentPostSho,3";
		...
		else 
		{
		    $xxx = "Vegetarian";
		    $aa = "vegetarian";
		    $sql = "SELECT * FROM  recipesmarco WHERE vegetarian = '$xxx' OR vegetarian = '$aa'  ORDER BY id desc LIMIT 0,3";
		...
		?>
			...
			<nav style="padding: 25px;">
				...
				<ul class="pagination pagination-lg">
					...
					<li class="page-item" > <a href="FrontVegetra.php?page=<?php echo $Page-1;?>" class="page-link">&laquo;</a></li>
					...
					$sql = "SELECT COUNT(*) FROM recipesmarco WHERE vegetarian = '$xxx' OR vegetarian = '$aa' ";
					...
					<li class="page-item" > <a href="FrontVegetra.php?page=<?php echo $i;?>" class="page-link"><?php echo $i;?></a></li>
					<?php }?>
					...
					<li class="page-item" > <a href="FrontVegetra.php?page=<?php echo $Page+1;?>" class="page-link">&raquo;</a></li>
